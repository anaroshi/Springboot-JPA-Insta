...
<%@ include file="../include/nav.jsp" %>
  ...
  <main id="profile">
    <header class="profile__header">
      ...
      <div class="avatar__container">
          ...
          <img src="/upload/${user.profileImage}" onerror="this.onerror=null; this.src='/images/avatar.jpg'" id="profile_image" class="profile_image" style="cursor:pointer" />
      </div>
  ...
  <div class="profile__overlay">
    ...
    <div class="profile__overlay-container">
		...
		<a href="/logout" class="profile__overlay-link">Log Out</a>
  ...
  <script type="text/javascript">
	$(document).ready(function() {
        ...
        //업로드 파일 체인지가 됐을경우 실행되는 이벤트  form태그에 fileProfile은 hidden으로 넣어줌
